    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 p-6">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center space-x-2">
              <Flask className="text-green-400" />
              ...
              <div className="text-center">
                <div className="text-sm text-gray-400 mb-2">Current pH: 
                  <span className={`ml-2 font-bold ${
                    ...
                    currentPH > 10 ? 'text-blue-400' :
                    currentPH > 8 ? 'text-green-400' :
                    'text-white'
                  }`}>
                    {currentPH.toFixed(1)}
                  </span>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-blue-400 font-bold">{temperature}°C</span>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2 max-h-32 overflow-y-auto">
                {selectedChemicals.map((chemical, index) => (
                  <div key={index} className="text-sm text-gray-300 bg-gray-800/50 rounded px-3 py-2 flex justify-between items-center">
            ...
            {geminiLoading ? (
              ...
              <div className="space-y-4">
                <div className="bg-gray-800/50 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 whitespace-pre-line font-light text-sm leading-relaxed">{reactionResult.description}</p>
                  {geminiAnalysis && (
                    <div className="mt-4">
