...
// Firebase removed
interface User {}
import { Microscope, Eye, Dna, Heart, Leaf, ZoomIn, ZoomOut, RotateCcw, Save, Search, Beaker } from 'lucide-react';
...
const BioGenericSimulation: React.FC<{ config: BioSimulationConfig; onSave: (snap: any)=>void }> = ({ config, onSave }) => {
  ...
  return (
    <div className="grid lg:grid-cols-3 gap-6">
      <div className="bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 p-5">
        <div className="flex items-start justify-between mb-2">
          <h3 className="text-xl font-bold text-white pr-4 flex-1">{config.name}</h3>
          <span className="text-[10px] px-2 py-1 rounded-full bg-green-600/30 border border-green-500/40 text-green-200">{config.category}</span>
        </div>
        <p className="text-xs text-gray-300 mb-3 leading-relaxed">{config.description}</p>
    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mb-8 overflow-x-auto">
          <div className="bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 p-2 min-w-fit">
            <div className="flex space-x-2">
              {[
                { id: 'microscope', label: 'Microscopy', icon: Microscope },
                { id: 'dna', label: 'DNA Analysis', icon: Dna },
                { id: 'anatomy', label: 'Human Anatomy', icon: Heart },
                { id: 'photosynthesis', label: 'Photosynthesis', icon: Leaf },
                { id: 'bio-sims', label: 'Biology Sims', icon: Beaker }
              ].map(exp => {
                const Icon = exp.icon;
                return (
                  <button
                ...
                <div className="space-y-4">
                  {dnaSequence.step !== 'dna' && (
                    <div className="bg-blue-600/20 rounded-lg p-4 border border-blue-600/30">
                      <div className="text-blue-300 font-medium mb-2">mRNA Sequence</div>
                  ...
                  {dnaSequence.step === 'protein' && (
                    <div className="bg-green-600/20 rounded-lg p-4 border border-green-600/30">
                      <div className="text-green-300 font-medium mb-2">Protein Sequence</div>
            ...
            <div className="bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 p-6">
              ...
              <div className="h-96 relative overflow-hidden rounded-lg bg-gradient-to-br from-blue-900/20 to-purple-900/20">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-black/50 rounded-lg p-3">
                    <div className="text-sm text-gray-300 mb-1">Current Sequence:</div>
              ...
              <div className="mt-4 grid grid-cols-4 gap-2 text-center">
                <div className="bg-red-600/20 rounded p-2">
                  ...
                  <div className="text-xs text-gray-400">Adenine</div>
                </div>
                <div className="bg-blue-600/20 rounded p-2">
                  <div className="text-blue-400 font-bold">T</div>
                  <div className="text-xs text-gray-400">Thymine</div>
                </div>
                <div className="bg-green-600/20 rounded p-2">
                  <div className="text-green-400 font-bold">C</div>
                  <div className="text-xs text-gray-400">Cytosine</div>
                </div>
                <div className="bg-yellow-600/20 rounded p-2">
                  <div className="text-yellow-400 font-bold">G</div>
                  <div className="text-xs text-gray-400">Guanine</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full"
                  />
                  <div className="text-yellow-400 text-center mt-1">{lightIntensity}%</div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full"
                  />
                  <div className="text-blue-400 text-center mt-1">{co2Level}%</div>
                </div>
              </div>

              <div className="mt-8 p-4 bg-green-800/20 rounded-lg border border-green-600/30">
                <h3 className="text-green-300 font-medium mb-2">Photosynthesis Equation</h3>
              ...
              <div className="flex space-x-2 mt-6">
                ...
                <button
                  onClick={saveExperiment}
                  className="flex-1 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors flex items-center justify-center space-x-2"
                >
                  <Save size={16} />
                  <span>Save (Local)</span>
                </button>
            ...
            <div className="bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 p-6">
              ...
              <div className="h-64 relative rounded-lg bg-gradient-to-b from-blue-400/20 to-green-600/20 overflow-hidden">
                {/* Sun */}
                <div 
            ...
            <div className="bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 p-6">
              ...
              <div className="space-y-6">
                <div className="bg-blue-600/20 rounded-lg p-4 border border-blue-600/30">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-blue-300 font-medium">Oxygen (O₂)</span>
                ...
                <div className="bg-green-600/20 rounded-lg p-4 border border-green-600/30">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-green-300 font-medium">Glucose (C₆H₁₂O₆)</span>
              ...
              <div className="mt-8 space-y-3">
                <div className="bg-gray-800/50 rounded-lg p-3">
                  <div className="text-sm text-gray-400">Limiting Factor</div>
            ...
            <div className="bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 p-6">
              ...
              <div className="grid md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="flex items-center text-xs text-gray-400 space-x-4">
                  <span>Total: <span className="text-green-400 font-semibold">{biologySimulations.length}</span></span>
                  <span>Filtered: <span className="text-blue-400 font-semibold">{filteredBioSims.length}</span></span>
                </div>
              </div>
              <div className="grid md:grid-cols-3 gap-3">
                {filteredBioSims.map(sim=> (
                  <button key={sim.id} onClick={()=> setSelectedBioSim(sim.id)} className={`text-left p-3 rounded-xl border transition-all duration-200 text-xs space-y-1 ${selectedBioSim===sim.id ? 'bg-green-600/30 border-green-500/50':'bg-gray-900/40 border-white/10 hover:border-green-400/40 hover:bg-green-600/10'}`}> 
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-white">{sim.name}</span>
                      <span className="text-[9px] px-1.5 py-0.5 rounded bg-green-700/40 text-green-200">{sim.category}</span>
                    </div>
                    <div className="text-gray-300 line-clamp-2 h-8 overflow-hidden">{sim.description}</div>
